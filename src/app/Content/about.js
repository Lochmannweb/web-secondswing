export const aboutData = {
    ...
    ChooseUs: {
        ...
        reasonOne: {
            title: "Mere golf, mindre omkostning",
            content: "- Kvalitetsudstyr til en brøkdel af nyprisen"
        },
        reasonTwo: {
            title: "Enkel og sikker handel",
            content: "- Vi gør det let at købe og sælge"
        },
        reasonThree: {
            title: "Fællesskab for golfspillere",
            content: "- Skabt af golfere, for golfere"
        },
        reasonFour: {
            title: "Giv dit golfudstyr nyt liv",
            content: "- og find dit næste sæt hos os!"
        },
    },
}